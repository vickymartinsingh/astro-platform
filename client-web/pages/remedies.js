...
export default function RemediesPage() {
  ...
  return (
    <Layout>
      <div className="overflow-hidden rounded-2xl bg-brand p-5
                      text-dark-text">
        ...
        <button onClick={() => router.push('/astrologers')}
          className="mt-4 rounded-full bg-dark-text px-5 py-2.5 text-sm
        ...
        {CATS.map(([name, desc, price]) => (
          <button key={name}
            ...
            <span className="flex h-11 w-11 items-center justify-center
              rounded-xl bg-brand-soft text-xl">✨</span>
