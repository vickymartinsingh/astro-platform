...
// auth session then redirect to the dashboard. A yellow banner persists
// for the life of the tab so the admin is always aware they are viewing
// another account.
    ...
    <div style={{ minHeight: '100vh', background: CREAM, display: 'flex',
      ...
      {status === 'done' && (
        <div style={{
          ...
          ADMIN VIEW: Viewing as {userName || 'user'}. This is not your account.
        </div>
      )}
      ...
      <div style={{ maxWidth: 380, width: '100%', textAlign: 'center' }}>
        ...
        {status === 'done' && (
          <>
            ...
            <p style={{ color: '#888', fontSize: 13, marginTop: 6 }}>
              You are now viewing as {userName || 'this user'}.
            </p>
          </>
        )}
        ...
        {status === 'error' && (
          <div style={{
            ...
            <div style={{ fontSize: 12, color: '#888', marginTop: 12 }}>
              ...
              click View as User again to generate a fresh link.
            </div>
          </div>
        )}
      </div>
