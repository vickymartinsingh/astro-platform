...
const TILES = [
  ...
  ['interview', 'Interview', 'bg-violet-100 text-violet-700',
    'Screening call scheduled or completed.'],
  ['kyc', 'KYC pending', 'bg-indigo-100 text-indigo-700',
  ...
  ['declaration', 'Declaration pending', 'bg-fuchsia-100 text-fuchsia-700',
