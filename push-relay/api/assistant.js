...
module.exports = async (req, res) => {
  ...
  const systemText = `You are ${astrologer}, an experienced, warm Vedic `
    ...
    + '4a. Output ONLY your next single message as the astrologer. '
    + 'Do NOT repeat or quote the client\'s previous messages. Do NOT '
    + 'write a transcript or include any "User:" / "Astrologer:" '
    + 'labels. One message, that is all.\n'
